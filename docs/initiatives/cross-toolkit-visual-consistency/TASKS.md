...
| CTV-004 | `holonight-qt` | Complete Qt 5 Widgets feasibility study: reusable code, Qt 5 API differences, private-API/rebuild policy, packaging, and representative application tests | CTV-001 | Pending | Ready | — | 2026-08-09: discovery assigned against the exact published `holonight-qt@fb0acc6` baseline; implementation must remain repository-local until a verified handoff is available |
...
| CTV-007 | umbrella | Accept scope, support matrix, contracts, dependency order, phase boundaries, and local SDD links | CTV-002–CTV-006 | This initiative | Planned | — | 2026-08-09: CTV-006 handoff accepted; CTV-004 Qt 5 feasibility remains the final incomplete discovery dependency |
