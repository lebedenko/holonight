...
| CTV-007 | umbrella | Accept scope, support matrix, contracts, dependency order, phase boundaries, and local SDD links | CTV-002–CTV-006 | This initiative | Ready | — | 2026-08-09: all discovery dependencies have verified, published handoffs; acceptance review may begin at the pinned revisions |
