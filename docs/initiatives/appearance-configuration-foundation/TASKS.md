...
| ACF-003 | `holonight-config` (repository to create) | Implement and publish canonical neutral appearance schema, defaults, validation, path resolution, atomic TOML serialization, diagnostics, and test helpers | ACF-002 | Pending | Planned | — | Waiting for repository creation and local SDD |
