...
| ACF-005 | `holonight-settings` | Adopt canonical appearance writer and Shell-owned product-config package; remove duplicate schemas and mixed appearance/product save transactions | ACF-003–ACF-004, ACF-006 | Pending | Planned | — | Waiting for local SDD and provider packages |
