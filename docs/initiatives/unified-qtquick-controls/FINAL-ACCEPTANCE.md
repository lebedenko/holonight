...
checks accepted, Fusion Settings palette P03 subsequently closed by the 2026-09-18 observer-repair review.
...
closes the Weather repair at scale 1 and 1.25. The subsequent [Settings scale-1 interaction/origin review](FINDINGS.md#settings-sway-scale-1-human-acceptance--2026-09-18)
accepts the requested two-style sidebar/Appearance/focus/selectors/City-editing scope. UQC-201 remains In Progress and the
...
| Settings sidebar/Appearance scrolling, focus, reachable Appearance selectors and unsaved City editing | Sway | Embedded default and Fusion / 1 | Accepted; [both reviewed runs](FINDINGS.md#settings-sway-scale-1-human-acceptance--2026-09-18) report no issues, measured DPR 1, verified staged origins and normal exits. No inaccessible controls reported; no rerun. |
| Settings navigation/editing/selectors, with non-blocking Appearance/Weather composition difference | Sway | Embedded default and Fusion / 1.25 | [Reviewed results and user disposition](FINDINGS.md#batch-8-settings-fractional-results-and-composition-disposition--2026-09-17); the subsequent [focused scale-1 interaction batch](FINDINGS.md#settings-sway-scale-1-human-acceptance--2026-09-18) is also accepted. Separate Settings-local composition SDD; no composition repair. |
| Settings Weather row centering and Fusion hover (including accepted subtle closed-button feedback) | Sway | Embedded default and Fusion / 1 and 1.25 | Accepted; [UQC-220 review](FINDINGS.md#uqc-220-fractional-repair-acceptance--2026-09-17). Focused repair scope only; subsequent [scale-1 interaction acceptance](FINDINGS.md#settings-sway-scale-1-human-acceptance--2026-09-18) is recorded separately. |
