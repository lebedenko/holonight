...
| UQC-223 | `holonight-qt` | Diagnose palette reversals after window interaction; establish owner and bounded repair contract | Reviewed post-UQC-222 P03 human evidence | [Diagnosis handoff](UQC-223.md); local SDD pending assignment | Ready | Provider `e94ceddbd3c0e4cb29e21bcdfd6758e3e4639f4f`; umbrella `400502d` | 2026-09-18: diagnosis assigned; main-window button reversals in both styles and Settings native-control reversals are corroborated; focus/hover/VT cause unproven. No repair assigned. Fusion light-time construction still missing. |
