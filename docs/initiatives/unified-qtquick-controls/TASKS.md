...
| UQC-207 | `holonight-qt` | Shared icon/menu/selection/focus rendering | UQC-204 (repair order) | [Local SDD](../../../holonight-qt/docs/sdd/unified-qtquick-controls/UQC-207.md) | In Progress | `fbffc872c31ad8c8c22d499a08c8259e781f0a51` | 2026-09-14: published rendering handoff; 77/77 provider checks, installed acceptance and static checks pass. Manual review rejects icon and Switch-outline acceptance; selection, F04, new popup transparency and crash attribution remain open. Tested F03 traversal is reported accepted. See [latest classifications](FINDINGS.md#batch-3-manual-review-and-external-ownership--2026-09-14). |
