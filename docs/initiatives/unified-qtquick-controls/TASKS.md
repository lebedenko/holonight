...
| UQC-220 | `holonight-qt` | Weather popup label centering and desktop hover policy | User-requested Settings recurrence; provider ownership reproduced | [Assignment](UQC-220.md); [local SDD](../../../holonight-qt/docs/sdd/unified-qtquick-controls/UQC-220.md) | Done | `7e101bd23661f21efe95cd11dad092069c68601d` | 2026-09-17: both baseline regressions fail then pass; provider 87/87, installed acceptance, fractional composites and private Wayland hover/explicit-disable checks pass. Published canonical repair confirmed before pinning. Fresh restored kit `holonight-uqc207-t9ao_81w` verified; [manual repair accepted at both scales](FINDINGS.md#uqc-220-fractional-repair-acceptance--2026-09-17), including subtle Fusion closed-button hover; close-key-only kit config deviation recorded. |
| UQC-221 | `holonight-qt` | Diagnose AI Settings palette propagation and identify repair contract | P03 from reviewed Batch 8 AI evidence | [Diagnosis](UQC-221.md); [Provider SDD](../../../holonight-qt/docs/sdd/unified-qtquick-controls/UQC-221.md) | Done | `30fda50634235a6564c13adcda81fea7ac7212e2` | 2026-09-17: published diagnostic handoff confirmed before pinning. Two deterministic 18-process matrices; existing-control positive checks pass; P03 64 failures and provider-free Fusion recreation 8 failures explicitly retained. Provider 29/29 focused registered checks and static/licensing checks pass. Shared window live palette contract owns the proposed repair; shared composites already update. Production and kit unchanged; P03 open. |
| UQC-222 | `holonight-qt` | Establish HnApplicationWindow live default palette with override and recreation coverage | UQC-221 diagnosis | [Repair SDD](../../../holonight-qt/docs/sdd/unified-qtquick-controls/UQC-222.md); [handoff](UQC-222.md) | Done | `e94ceddbd3c0e4cb29e21bcdfd6758e3e4639f4f` | 2026-09-17: published provider repair confirmed before pinning. 91/91 full provider CTests including installed acceptance; 33/33 focused checks; two deterministic 18-process matrices with passing shared-window assertions. Plain Window and provider-free Fusion boundary failures retained. P03 open; no new kit/manual runs. |
| UQC-223 | `holonight-qt` | Diagnose palette reversals after window interaction; establish owner and bounded repair contract | Reviewed post-UQC-222 P03 human evidence | [Diagnosis handoff](UQC-223.md); [provider SDD](../../../holonight-qt/docs/sdd/unified-qtquick-controls/UQC-223.md) | Done | `44293e578e313fe3dc43e9f3b64337af310cd606` | 2026-09-18: clean canonical diagnostic handoff confirmed before pinning. Allocating observer exposes Qt stale root-content palette; activation restores construction colors at unchanged scheme. 74-process collection; 26 intentionally failing cases, passive activation stable; repeated DPR/style/history pairs agree. 12 override/reset comparisons; window/Core 5/5 and policy 4/4 pass. Proposed repair owner: provider audit instrumentation. No production fix; P03 open. |
| UQC-224 | `holonight-qt` | Repair passive palette observer and verify actual shared library | UQC-223 | [Assignment](UQC-224.md); [provider SDD](../../../holonight-qt/docs/sdd/unified-qtquick-controls/UQC-224.md) | Done | `eadfe482000e64ee7ead83d63f878e3f365686b1` | 2026-09-18: clean canonical handoff confirmed; 98 processes and 49 on/off equivalence pairs pass, 13/13 narrow CTests and static checks pass. Allocating boundary failure retained. P03 closed after [human acceptance](FINDINGS.md#p03-human-acceptance-after-observer-repair--2026-09-18). |
...
### Batch 8 post-repair revalidation and AI handoff — 2026-09-17

[Release evidence](BATCH8-REVALIDATION.md) records clean canonical pins at `c16b164`,
fresh dependency-order suites and installed/negative/runtime matrices, all
failures/retries, package provenance, 287 verified hashes, exact-prefix restoration
and existing-path refusal. Provider remains `7e101bd`; no gitlink or product change.
The new kit hashes its Sway close binding from the outset; the prior repair kit's
documented deviation remains preserved. The final checklist now reflects completed
UQC-220 acceptance while retaining broader Settings gaps and earlier acceptances.

Next session is limited to [two AI Sway runs](BATCH8-AI.md), default/Fusion at
output scale 1 and application DPR 1.25, isolated offline profiles and palette
observation. Bootstrap/global versus scene palette scope is explicit. Review both
before another batch. No manual application or privileged acceptance procedure
was executed here. UQC-201 remains In Progress, UQC-220 Done, initiative Accepted;
successful authentication, shipped-service activation, pre-session greeter operation
and other unresolved cells remain pending.


### Batch 8 AI evidence verification — 2026-09-17

[Canonical review](FINDINGS.md#batch-8-ai-sway-evidence-review--2026-09-17) verifies
both submitted runs: 287 kit hashes, release/archive identity, matching versions,
staged executable/mappings, correct selectors, palette-only observation, DPR 1.25
at output scale 1, isolated disabled providers and exit 0. Owned workspace/Settings
backgrounds complete dark/light/dark; native/global palette scope remains explicit.
User accepts editing/navigation, selectors/popups, scrolling and main-window
palette transitions in both styles. Fusion Settings control backgrounds fail the
palette transition (P03); UQC-221 Planned for bounded ownership diagnosis. No next
manual batch, repeated runs, product tests, pin or kit changes.
UQC-201 In Progress; initiative Accepted; other human gates unchanged.

## UQC-221 diagnostic handoff — 2026-09-17

Assignment checkpoint `d517c4d` preceded provider work at the clean published
pins from umbrella `f1f4d41`. Provider diagnosis `30fda50634235a6564c13adcda81fea7ac7212e2`
was published and confirmed on canonical origin/main before this gitlink update.
[Proven diagnosis](UQC-221.md) and [repair proposal](UQC-222.md) separate stale
native palettes from appearance-bound composites and a provider-free Fusion
new-window initialization boundary. No product code or released kit changed.
Two 18-process diagnostic matrices agree; positive checks and 29 focused provider
CTest entries pass. P03 and external assertions intentionally fail and are retained
in the provider SDD. Static/lint/licensing and whitespace checks pass, with tidy
advisories disclosed. UQC-221 Done; UQC-222 Planned; P03 open; UQC-201 In Progress;
initiative Accepted. No repeat manual run or umbrella integration claim.

## UQC-222 assignment — 2026-09-17

All clean pins reconfirmed against canonical origin/main. Assign holonight-qt at
`30fda50634235a6564c13adcda81fea7ac7212e2`; the [local SDD](../../../holonight-qt/docs/sdd/unified-qtquick-controls/UQC-222.md)
settles inherited palette defaults and override/lifetime coverage. UQC-222 Ready;
commit this assignment before implementation. UQC-201 In Progress, initiative
Accepted, P03 open. No new kit or manual runs.

## UQC-222 published repair handoff — 2026-09-17

Provider implementation `cb7d8d070204afc2fc7c0f695b33906c4e487363` and verification
record `e94ceddbd3c0e4cb29e21bcdfd6758e3e4639f4f` published to canonical main;
remote head confirmed before updating the provider gitlink. Provider working tree
is clean. Assignment checkpoint was `5a01259` at the published diagnostic baseline.

[Local SDD](../../../holonight-qt/docs/sdd/unified-qtquick-controls/UQC-222.md) retains
baseline regression failures and final verification: 5/5 window/Core checks,
33/33 palette/composite/Core/import checks, 91/91 full provider CTests including
installed acceptance. Two isolated 18-process matrices match all normalized
palette/background/rendered-sample measurements. Shared-window and application
positive assertions pass; plain Window 32 failures and provider-free Fusion
recreation 8 failures remain independent boundary evidence. Static/licensing
checks pass; tidy advisories and PNG border-animation variability are disclosed.
...
## P03 reviewed human evidence — 2026-09-18

[Canonical review](FINDINGS.md#p03-human-evidence-review--2026-09-18) verifies
`sway-kr8jfdwd`: exactly two normal-exit processes, expected styles, staged origins,
isolated offline profiles, palette-only diagnostics, measured DPR 1.25/output 1
and matching log/kit hashes. Preserve immediate Settings transition passes and
default light-time construction. P03 stays open for corroborated palette reversals
and missing Fusion light-time construction. [UQC-223](UQC-223.md) is Planned,
provider-first diagnosis only. Earlier accepted coverage remains scoped; no next
manual batch. UQC-222 Done, UQC-201 In Progress, initiative Accepted.


## UQC-223 accepted diagnostic handoff — 2026-09-18

Ready assignment `e3fd3a8` preceded provider diagnostics from `e94cedd`.
Published canonical `44293e5` accepted and pinned after clean-head verification.
[Canonical finding](FINDINGS.md#uqc-223-observer-induced-palette-reversals--2026-09-18)
records diagnosis ownership and evidence limits; the provider-local SDD owns
...
## P03 human closure after UQC-224 — 2026-09-18

[Canonical review](FINDINGS.md#p03-human-acceptance-after-observer-repair--2026-09-18) accepts Fusion
`ai-1789694234005895895` and replacement default `ai-1789694664696866037`.
Initial default `ai-1789693711744645419` is retained, excluded from construction
acceptance per the user's sequencing correction. The user confirms every required
surface checked with no issues. Read-only replay verifies identities, normal
exits, DPR 1.25/output 1, staged origins, isolated profiles, four scheme commands,
per-phase activation/hover and stable role maps for 17 tracked instances per run.
