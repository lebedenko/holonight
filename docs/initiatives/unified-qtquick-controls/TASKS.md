...
| UQC-221 | `holonight-qt` (diagnosis first; repair owner provisional) | Reduce AI Fusion Settings live-palette mismatch and establish the narrow owner | P03 from reviewed Batch 8 AI evidence | [Bounded follow-up](UQC-221.md); provider-local SDD required before Ready | Planned | Provider `7e101bd23661f21efe95cd11dad092069c68601d`; AI evidence `7e25e78cc7fb33aa63ed480bc3f328a65e04ca0c` | User accepts interaction and main-window transitions; Fusion Settings input/numeric/ComboBox backgrounds stay dark. Read-only source review suggests shared palette propagation; reduced ownership proof pending. No implementation assigned. |
