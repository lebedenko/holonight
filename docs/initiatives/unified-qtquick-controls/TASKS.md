...
| UQC-208 | `holonight-qt` | Palette transitions and picker-state investigation | UQC-204 (repair order) | [Local SDD](../../../holonight-qt/docs/sdd/unified-qtquick-controls/UQC-208.md) | In Progress | `5d3f06e895be5b5a93ed07f8fe717a0fa6cc6cbb` | 2026-09-14: Ready then In Progress; external P01 activation reproduced, provider Light-role omission repaired. 87/87 provider tests pass; publication confirmed before pinning. Actual-app palette/picker acceptance pending; see [canonical findings](FINDINGS.md#batch-4-palette-investigation-and-repair--2026-09-14). |
