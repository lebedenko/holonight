...
| UQC-222 | `holonight-qt` (proposed) | Establish HnApplicationWindow live default palette with override and recreation coverage | UQC-221 diagnosis | [Bounded repair proposal](UQC-222.md) | Planned | Provider diagnostic handoff `30fda50634235a6564c13adcda81fea7ac7212e2` | Repair-local SDD and precise Core-safe palette bridge contract required before Ready. No repair assigned by the diagnosis-only iteration. |
