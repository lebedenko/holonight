...
| UQC-222 | `holonight-qt` | Establish HnApplicationWindow live default palette with override and recreation coverage | UQC-221 diagnosis | [Repair SDD](../../../holonight-qt/docs/sdd/unified-qtquick-controls/UQC-222.md) | Ready | Provider diagnostic handoff `30fda50634235a6564c13adcda81fea7ac7212e2` | Assigned at published baseline; Core inherited-default bridge contract settled in local SDD. P03 remains open; no new kit/manual runs. |
