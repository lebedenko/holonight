...
readonly MODULES=(holonight-config holonight-qt holonight-appearance-adapters holonight-icons holonight-system-services holonight-shell holonight-settings holonight-viewer holonight-ai holonight-pkg-manager holonight-greeter holonightd)
